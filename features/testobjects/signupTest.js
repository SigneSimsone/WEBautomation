...
export class SignupTest {
    ...
    async assertCheckEmailPage(){
        ...
        expect(await pages.checkEmailPage.getEmailText().getText()).toEqual(`We sent an email to ${await data.userData.oracleUser.email} with a button to verify your email address.`);
    }
}